        ...
        <div className="absolute top-10 right-0 mt-2 w-48 bg-white shadow-lg rounded-md z-50">
          <ul className="pl-6">
            <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer">
              <a href="/" onClick={closeMenu} style={{ fontSize: '16px', fontWeight: 'bold', textDecoration: 'none', color: '#658E9C' }}>Home</a>
            </li>
            <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer">
              <a href="/map" onClick={closeMenu} style={{ fontSize: '16px', fontWeight: 'bold', textDecoration: 'none', color: '#658E9C' }}>Map</a>
            </li>
            <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer">
              <a href="/inforecycle" onClick={closeMenu} style={{ fontSize: '16px', fontWeight: 'bold', textDecoration: 'none', color: '#658E9C' }}>Recycle</a>
            </li>
            <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer">
